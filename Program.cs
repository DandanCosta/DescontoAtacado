﻿var produtos = new List<Produto>()
{
    ...
    new Produto { Gtin = 7896066334509, Descricao = "TORRADA TRADICIONAL WICKBOLD PACOTE", PrecoVarejo = 5.19m, PrecoAtacado = 0, UnidadesAtacado = 0 },
    ...
    new Produto { Gtin = 7894321711263, Descricao = "ACHOCOLATADO PÓ ORIGINAL TODDY POTE 400G", PrecoVarejo = 9.79m, PrecoAtacado = 0, UnidadesAtacado = 0 },
    ...
    new Produto { Gtin = 7891025301516, Descricao = "DANONINHO PETIT SUISSE COM POLPA DE MORANGO 360G DANONE", PrecoVarejo = 12.99m, PrecoAtacado = 0.00m, UnidadesAtacado = 0 },
...
{
    new ItemVenda { Sequencia = 1, Gtin = 7891048038017, Quantidade = 1, Parcial = 4.40m },
    new ItemVenda { Sequencia = 2, Gtin = 7896004400914, Quantidade = 4, Parcial = 16.80m },
    new ItemVenda { Sequencia = 3, Gtin = 7891030003115, Quantidade = 1, Parcial = 3.12m },
    new ItemVenda { Sequencia = 4, Gtin = 7891024110348, Quantidade = 6, Parcial = 17.28m },
    new ItemVenda { Sequencia = 5, Gtin = 7898080640017, Quantidade = 24, Parcial = 167.76m },
    new ItemVenda { Sequencia = 6, Gtin = 7896004400914, Quantidade = 8, Parcial = 33.60m },
    new ItemVenda { Sequencia = 7, Gtin = 7891700203142, Quantidade = 8, Parcial = 19.12m },
    new ItemVenda { Sequencia = 8, Gtin = 7891048038017, Quantidade = 1, Parcial = 4.40m },
    new ItemVenda { Sequencia = 9, Gtin = 7793306013029, Quantidade = 3, Parcial = 38.37m },
    new ItemVenda { Sequencia = 10, Gtin = 7896066334509, Quantidade = 2, Parcial = 10.38m },
};
...
foreach (var grupo in itens.GroupBy(i => i.Gtin))
{
    ...
    int qtdItens = (int)itens.Where(i => i.Gtin == grupo.Key).Sum(i => i.Quantidade);
